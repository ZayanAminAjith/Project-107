##Maam, the tracking is very glitchy so I put another video and tried it and it was tracking the ball.
##You can check by changing the video from this ->(video = cv2.VideoCapture("footvolleyball.mp4"))
##to this ->(video = cv2.VideoCapture("1.mp4"))
